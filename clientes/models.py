...
class Cliente(models.Model):
    ...
    estado_cliente = models.CharField(maxlength=50, choices=[('ya compró', 'ya compró'), ('perdido', 'perdido')])
    duplicados = models.BooleanField(default=False)
    ventas_relacionadas = models.TextField()
    color = models.CharField(maxlength=50)
    telefono2 = models.CharField(maxlength=15)
    label_clientes2 = models.CharField(maxlength=255)
