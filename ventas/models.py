...
class Venta(models.Model):
    ...
    tienda = models.CharField(maxlength=20, choices=[('Madrid', 'Madrid'), ('Barcelona', 'Barcelona'), ('Valencia', 'Valencia'), ('Videollamada', 'Videollamada')])
    envio_entrega = models.BooleanField(default=False)
    estado_entrega = models.CharField(maxlength=50, choices=[('Por Entregar o Enviar', 'Por Entregar o Enviar'), ('Entregado o Enviado', 'Entregado o Enviado'), ('Vestido Devuelto', 'Vestido Devuelto')])
    tipo = models.CharField(maxlength=20, choices=[('Alquiler', 'Alquiler'), ('Venta', 'Venta')])
    ...
    estado_deposito = models.CharField(maxlength=50, choices=[('Pendiente de Entrega', 'Pendiente de Entrega'), ('Entregado por el Cliente', 'Entregado por el Cliente'), ('Devuelto al Cliente', 'Devuelto al Cliente')], null=True, blank=True)
    ...
    estado_pago = models.CharField(maxlength=50)
    comentarios = models.TextField(null=True, blank=True)
    estado_venta = models.CharField(maxlength=50)
    ...
    nombre_calendario = models.CharField(maxlength=255, null=True, blank=True)
    ...
    tiara = models.CharField(maxlength=50, choices=[('Entregada', 'Entregada'), ('No entregada', 'No entregada'), ('Sin tiara', 'Sin tiara')], null=True, blank=True)
    cancan = models.CharField(maxlength=50, choices=[('3 aros', '3 aros'), ('6 aros', '6 aros'), ('8 aros', '8 aros')], null=True, blank=True)
